...
(function (g, U, J) {
  ...
  function (g, U) {
    ...
    function S(d, c, a) {
      ...
      a.imageSmoothing &&
        (c.imageSmoothingEnabled = c.mozImageSmoothingEnabled =
          a.imageSmoothingEnabled);
    }
    function ya(d, c, a) {
      a.mask &&
        (a.autosave && fa(d, c), d.clip(), c.transforms.masks.push(a._args));
    }
    function W(d, c, a) {
      a.closed && c.closePath();
      a.shadowStroke && 0 !== a.strokeWidth
        ? (c.stroke(),
          c.fill(),
    ...
    function Ca(d, c, a) {
      for (var b in Y.events)
        Y.events.hasOwnProperty(b) &&
          (a[b] || (a.cursors && a.cursors[b])) &&
          Da(d, c, a, b);
      c.events.mouseout ||
        (d.bind("mouseout.jCanvas", function () {
          var a = c.drag.layer,
            b;
    ...
    function ra(d, c, a, b, f) {
      b[a] &&
        c._running &&
        !c._running[a] &&
        ((c._running[a] = !0), b[a].call(d[0], c, f), (c._running[a] = !1));
    }
    ...
    function Fa(d, c) {
      ...
      for (b = 0; b < V.props.length; b += 1)
        (a = V.props[b]),
          void 0 !== d[a] &&
            ((d["_" + a] = d[a]), (V.propsObj[a] = !0), c && delete d[a]);
    }
    function Va(d, c, a) {
      var b, f, e, h;
      for (b in a)
    ...
    function Wa(d) {
      ...
      1 !== d.start[3] || 1 !== d.end[3]
        ? (d.now = "rgba( " + d.now.join(",") + " )")
        : (d.now.slice(0, 3), (d.now = "rgb( " + d.now.join(",") + " )"));
      d.elem.nodeName
        ? (d.elem.style[d.prop] = d.now)
        : (d.elem[d.prop] = d.now);
    }
    function Ya(d) {
      ...
      if ((a = a._args))
        (d = H(d)),
          ...
          null !== b.x &&
            ...
            (f =
              c.isPointInPath(e, h) ||
              (c.isPointInStroke && c.isPointInStroke(e, h)))),
          (c = d.transforms),
          (a.eventX = b.x),
          (a.eventY = b.y),
          (a.event = b.event),
          ...
          (h = a.eventY),
          0 !== b
            ? ((a._eventX = e * L(-b) - h * P(-b)),
              (a._eventY = h * L(-b) + e * P(-b)))
            : ((a._eventX = e), (a._eventY = h)),
          (a._eventX /= c.scaleX),
          (a._eventY /= c.scaleY),
    ...
    function La(d, c, a, b, f, e, h, g) {
      ...
      b.arrowRadius &&
        ...
        (d = a.strokeWidth * L(t)),
        (n = a.strokeWidth * P(t)),
        (a = h + b.arrowRadius * L(t + b.arrowAngle / 2)),
        (f = g + b.arrowRadius * P(t + b.arrowAngle / 2)),
        (e = h + b.arrowRadius * L(t - b.arrowAngle / 2)),
        (b = g + b.arrowRadius * P(t - b.arrowAngle / 2)),
        c.moveTo(a - d, f - n),
        c.lineTo(h - d, g - n),
        c.lineTo(e - d, b - n),
        c.moveTo(h - d, g - n),
    ...
    function ga(d, c, a, b, f, e, h, g) {
      b._arrowAngleConverted ||
        ((b.arrowAngle *= a._toRad), (b._arrowAngleConverted = !0));
    ...
    function Ma(d, c, a, b) {
      ...
      for (
        void 0 !== b.x1 && void 0 !== b.y1 && c.moveTo(b.x1 + a.x, b.y1 + a.y);
        ;

      )
        if (((e = b["x" + f]), (h = b["y" + f]), void 0 !== e && void 0 !== h))
          c.lineTo(e + a.x, h + a.y), (f += 1);
        else break;
      --f;
      ha(
        d,
    ...
    function Na(d, c, a, b) {
      ...
      for (
        ...
        if (
          ...
          c.quadraticCurveTo(g + a.x, n + a.y, e + a.x, h + a.y), (f += 1);
        else break;
      --f;
      ha(
        d,
    ...
    function Oa(d, c, a, b) {
      ...
      for (
        ...
        if (
          ...
          c.bezierCurveTo(n + a.x, t + a.y, z + a.x, E + a.y, h + a.x, g + a.y),
            (f += 1),
            (e += 2);
        else break;
      --f;
    ...
    function Ra(d, c, a, b) {
      ...
      for (void 0 !== b.x && void 0 !== b.y && c.moveTo(e, h); ; )
        if (((e = b["a" + f]), (h = b["l" + f]), void 0 !== e && void 0 !== h))
          (g = t),
            (n = z),
            (t += Pa(a, e, h)),
            (z += Qa(a, e, h)),
    ...
    function ta(d, c, a, b) {
      ...
      if (
        f.text === a.text &&
        f.fontStyle === a.fontStyle &&
        f.fontSize === a.fontSize &&
        f.fontFamily === a.fontFamily &&
        f.maxWidth === a.maxWidth &&
        f.lineHeight === a.lineHeight
      )
    ...
    var Ia = U.document,
      ...
      V = {},
      Ua =
        "mousedown mousemove mouseup mouseover mouseout touchstart touchmove touchend".split(
          " "
        ),
    ...
    Y.extend = function (d) {
      d.name &&
        (d.props && Z(ma, d.props),
        (g.fn[d.name] = function a(b) {
          var f, e, h, g;
          for (e = 0; e < this.length; e += 1)
            if (((f = this[e]), (h = K(f))))
              (g = new J(b)), N(f, g, b, a), S(f, h, g), d.fn.call(f, h, g);
          return this;
        }),
    ...
    g.fn.getLayer = function (d) {
      ...
      if (0 !== this.length)
        if (
          ((c = this[0]), (a = H(c)), (c = a.layers), (f = aa(d)), d && d.layer)
        )
          b = d;
    ...
    g.fn.setLayer = function (d, c) {
      ...
      for (b = 0; b < this.length; b += 1)
        if (
          ((a = g(this[b])), (f = H(this[b])), (e = g(this[b]).getLayer(d)))
        ) {
          pa(a, f, e, c);
          qa(a, f, e, c);
          ka(c);
      ...
      if (void 0 !== d)
        for (a = 0; a < this.length; a += 1)
          if (
            ...
            for (b = b.slice(0), f = 0; f < b.length; f += 1)
              c.removeLayer(b[f]);
      return this;
    };
    g.fn.addLayerToGroup = function (d, c) {
      ...
      for (b = 0; b < this.length; b += 1)
        (a = g(this[b])),
          (f = a.getLayer(d)),
          f.groups &&
            ((e = f.groups.slice(0)), -1 === ia(c, f.groups) && e.push(c)),
          a.setLayer(f, { groups: e });
      return this;
    };
      ...
      for (c = 0; c < this.length; c += 1)
        (b = g(this[c])),
          (a = K(this[c])) &&
            ...
            a.visible &&
            a._method &&
            ((a._next = null), a._method.call(b, a));
      return this;
    };
          ...
          for (h = M; h < a.length; h += 1)
            if (
              ...
              z &&
                z.visible &&
                z._method &&
                ((z._next = e ? e : null), z._method.call(t, z)),
            ...
            if ("mousemove" === C || "touchmove" === C) {
              if (
                (k.dragging ||
                  ...
                  (m.dragging = !0),
                  m.bringToFront &&
                    (u.splice(m.index, 1), (m.index = u.push(m))),
                  (m._startX = m.x),
                  (m._startY = m.y),
                  (m._endX = m._eventX),
                  (m._endY = m._eventY),
                ...
                for (
                  ...
                  if (((k = y[u]), (B = x.layer.groups[k]), m.groups && B))
                    for (k = 0; k < B.length; k += 1)
                      B[k] !== m &&
                        ("y" !== m.restrictDragToAxis &&
                          "y" !== B[k].restrictDragToAxis &&
                          (B[k].x += m.dx),
                        "x" !== m.restrictDragToAxis &&
                          "x" !== B[k].restrictDragToAxis &&
                          (B[k].y += m.dy));
            } else if ("mouseup" === C || "touchend" === C)
              k.dragging &&
                ((m.dragging = !1), (k.dragging = !1), O(e, x, m, "dragstop")),
                (x.drag = {});
          }
          e = n.lastIntersected;
          null === e ||
            ...
            e._fired ||
            n.drag.dragging ||
            ((n.lastIntersected = null),
            (e._fired = !0),
            (e._hovered = !1),
            O(d, n, e, "mouseout"),
            d.css({ cursor: n.cursor }));
          f &&
            (f[z] || (X.mouseEvents[z] && (z = X.mouseEvents[z])),
            f._event &&
              f.intersects &&
              ((n.lastIntersected = f),
              !(f.mouseover || f.mouseout || f.cursors) ||
                n.drag.dragging ||
                f._hovered ||
                f._fired ||
                ((f._fired = !0), (f._hovered = !0), O(d, n, f, "mouseover")),
              f._fired || ((f._fired = !0), (t.type = null), O(d, n, f, z)),
              !f.draggable ||
                f.disableEvents ||
                ("mousedown" !== z && "touchstart" !== z) ||
                (n.drag.layer = f)));
          null !== f || n.drag.dragging || d.css({ cursor: n.cursor });
          h === a.length &&
            ((n.intersecting.length = 0),
            (n.transforms = la(oa)),
    ...
    g.fn.animateLayer = function () {
      ...
      function c(a, b, c) {
        return function (d, f) {
          ...
          c._pos !== f.pos &&
            ...
            c._animating ||
              b.animating ||
              ((c._animating = !0), (b.animating = !0), (b.animated = c)),
            (b.animating && b.animated !== c) || a.drawLayers());
      ...
      var a,
        ...
        M;
      "object" === aa(e[2])
        ? (e.splice(2, 0, e[2].duration || null),
          e.splice(3, 0, e[3].easing || null),
          e.splice(4, 0, e[4].complete || null),
          e.splice(5, 0, e[5].step || null))
        : (void 0 === e[2]
            ? (e.splice(2, 0, null), e.splice(3, 0, null), e.splice(4, 0, null))
            : da(e[2]) && (e.splice(2, 0, null), e.splice(3, 0, null)),
          void 0 === e[3]
            ? ((e[3] = null), e.splice(4, 0, null))
            : da(e[3]) && e.splice(3, 0, null));
      for (b = 0; b < this.length; b += 1)
        if (((a = g(this[b])), (f = K(this[b]))))
          (f = H(this[b])),
            (h = a.getLayer(e[0])) &&
              h._method !== g.fn.draw &&
              ((M = Z({}, e[1])),
    ...
    g.fn.delayLayer = function (d, c) {
      ...
      c = c || 0;
      for (b = 0; b < this.length; b += 1)
        if (((a = g(this[b])), (f = H(this[b])), (e = a.getLayer(d))))
          g(e).delay(c), O(a, f, e, "delay");
      return this;
    };
    ...
    g.event.fix = function (d) {
      ...
      if ((c = d.originalEvent))
        if (
          ((a = c.changedTouches), void 0 !== d.pageX && void 0 === d.offsetX)
        ) {
          if ((c = g(d.currentTarget).offset()))
            (d.offsetX = d.pageX - c.left), (d.offsetY = d.pageY - c.top);
        } else
          a &&
            (c = g(d.currentTarget).offset()) &&
            ((d.offsetX = a[0].pageX - c.left),
    ...
    g.fn.saveCanvas = function b(f) {
      ...
      for (e = 0; e < this.length; e += 1)
        if ((h = K(this[e])))
          for (
            n = H(this[e]), g = new J(f), N(this[e], g, f, b), t = 0;
            t < g.count;
            t += 1
          )
            fa(h, n);
    ...
    g.fn.restoreCanvas = function f(e) {
      ...
      for (h = 0; h < this.length; h += 1)
        if ((g = K(this[h])))
          for (
            t = H(this[h]), n = new J(e), N(this[h], n, e, f), z = 0;
            z < n.count;
            z += 1
          ) {
            var E = g,
              x = t;
            0 === x.savedTransforms.length
              ? (x.transforms = la(oa))
              : (E.restore(), (x.transforms = x.savedTransforms.pop()));
          }
      return this;
    };
            ...
            x.visible &&
              ...
              x.width &&
                ...
                (y = bb(x.cornerRadius))
                  ? ((m = x.x + x.width / 2),
                    (k = x.y + x.height / 2),
                    0 > x.width && ((B = C), (C = m), (m = B)),
                    0 > x.height && ((B = u), (u = k), (k = B)),
                    0 > m - C - 2 * y && (y = (m - C) / 2),
                    0 > k - u - 2 * y && (y = (k - u) / 2),
                    E.moveTo(C + y, u),
                    E.lineTo(m - y, u),
                    E.arc(m - y, u + y, y, (3 * F) / 2, 2 * F, !1),
                    E.lineTo(m, k - y),
                    E.arc(m - y, k - y, y, 0, F / 2, !1),
                    E.lineTo(C + y, k),
                    E.arc(C + y, k - y, y, F / 2, F, !1),
                    E.lineTo(C, u + y),
                    E.arc(C + y, u + y, y, F, (3 * F) / 2, !1),
                    (x.closed = !0))
                  : E.rect(C, u, x.width, x.height)),
              T(this[z], E, x),
              W(this[z], E, x));
      return this;
    };
          ...
          if (((m = new J(g)), N(this[C], m, g, E), m.visible)) {
            ...
            for (l = 0; l < m.sides; l += 1)
              (A = m.x + m.radius * L(k)),
                ...
                u.lineTo(A, p),
                m.concavity &&
                  ((A = m.x + (w + -w * m.concavity) * L(k + B)),
                  (p = m.y + (w + -w * m.concavity) * P(k + B)),
                  u.lineTo(A, p)),
                (k += y);
            T(this[C], u, m);
            m.closed = !0;
    ...
    g.fn.drawSlice = function x(C) {
      ...
      for (u = 0; u < this.length; u += 1)
        if ((g(this[u]), (m = K(this[u]))))
          (k = new J(C)),
            N(this[u], k, C, x),
            k.visible &&
              (Q(this[u], m, k, 2 * k.radius),
              S(this[u], m, k),
              (k.start *= k._toRad),
              (k.end *= k._toRad),
              (k.start -= F / 2),
              ...
              (y = (k.start + k.end) / 2),
              (B = k.radius * k.spread * L(y)),
              (y = k.radius * k.spread * P(y)),
              (k.x += B),
              (k.y += y),
              m.beginPath(),
          ...
          if (((l = new J(w)), (v = N(this[A], l, w, B)), l.visible)) {
            ...
            "left" === l.align
              ? l.respectAlign
                ...
                : (G -= l.width / 2)
              : "right" === l.align &&
                (l.respectAlign ? (l.x -= l.width / 2) : (G += l.width / 2));
            if (l.radius)
              for (
                G = ba(l.fontSize),
                ...
                for (H = 0; H < R; H += 1)
                  (I = r[H]),
                    ...
                    l.flipArcText && p.scale(-1, -1),
                    p.fillText(I, 0, 0),
                    "transparent" !== l.fillStyle &&
                      (p.shadowColor = "transparent"),
                    0 !== l.strokeWidth && p.strokeText(I, 0, 0),
                    p.restore();
                l.radius -= G;
              ...
              for (v = 0; v < D.length; v += 1)
                (r = D[v]),
                  (R =
                    l.y +
                    (v * l.height) / D.length -
                    ((D.length - 1) * l.height) / D.length / 2),
                  (p.shadowColor = l.shadowColor),
                  p.fillText(r, G, R),
                  "transparent" !== l.fillStyle &&
                    (p.shadowColor = "transparent"),
                  0 !== l.strokeWidth && p.strokeText(r, G, R);
            R = 0;
            "top" === l.baseline
              ? (R += l.height / 2)
              : "bottom" === l.baseline && (R -= l.height / 2);
            l._event &&
              (p.beginPath(),
              p.rect(
                l.x - l.width / 2,
    ...
    g.fn.measureText = function (g) {
      ...
      if ((g = K(this[0])))
        sa(this[0], g, w), (A = Sa(g, w)), ta(this[0], g, w, A);
      return w;
    };
    g.fn.drawImage = function w(A) {
      function p(l, w, p, q, r) {
        return function () {
          ...
          null === q.width &&
            null === q.sWidth &&
            (q.width = q.sWidth = I.width);
          null === q.height &&
            null === q.sHeight &&
            (q.height = q.sHeight = I.height);
          r && ((r.width = q.width), (r.height = q.height));
          null !== q.sWidth &&
          null !== q.sHeight &&
          null !== q.sx &&
          null !== q.sy
            ? (null === q.width && (q.width = q.sWidth),
              null === q.height && (q.height = q.sHeight),
              q.cropFromCenter &&
                ((q.sx += q.sWidth / 2), (q.sy += q.sHeight / 2)),
              0 > q.sy - q.sHeight / 2 && (q.sy = q.sHeight / 2),
              q.sy + q.sHeight / 2 > I.height &&
                (q.sy = I.height - q.sHeight / 2),
              0 > q.sx - q.sWidth / 2 && (q.sx = q.sWidth / 2),
              q.sx + q.sWidth / 2 > I.width && (q.sx = I.width - q.sWidth / 2),
              Q(l, w, q, q.width, q.height),
              S(l, w, q),
              w.drawImage(
                I,
                q.sx - q.sWidth / 2,
          ...
          q.layer &&
            ((r._masks = p.transforms.masks.slice(0)),
            q._next &&
              v.drawLayers({ clear: !1, resetFire: !0, index: q._next }));
        };
      }
      var l,
        v,
          ...
          (r = H(this[v])),
            ...
            G.visible &&
              ...
              I &&
                (I.complete || F
                  ? p(l, D, r, G, R)()
                  : ((I.onload = p(l, D, r, G, R)), (I.src = I.src))));
      return this;
    };
          ...
          da(G)
            ...
            : ((w = G.getContext),
              G.src || w
                ? (D = G)
                : ((D = new Ta()),
                  G.match(/^data:/i) || (D.crossOrigin = v.crossOrigin),
                  (D.src = G)),
              D.complete || w ? A() : ((D.onload = A), (D.src = D.src))))
        : (r = null);
      return r;
    };
    g.fn.createGradient = function (g) {
      ...
      if ((A = K(this[0]))) {
        ...
        A =
          null !== g.r1 && null !== g.r2
            ? A.createRadialGradient(g.x1, g.y1, g.r1, g.x2, g.y2, g.r2)
            : A.createLinearGradient(g.x1, g.y1, g.x2, g.y2);
      ...
      for (v = 0; v < this.length; v += 1)
        if (((l = this[v]), (D = K(l)))) {
          ...
          if (0 !== r.width && 0 !== r.height) {
            ...
            if (r.each)
              for (F = 0; F < L; F += 4)
                (G = { r: I[F], g: I[F + 1], b: I[F + 2], a: I[F + 3] }),
                  r.each.call(l, G, r),
                  (I[F] = G.r),
                  (I[F + 1] = G.g),
                  (I[F + 2] = G.b),
    ...
    g.fn.getCanvasImage = function (g, p) {
      ...
      0 !== this.length &&
        ((l = this[0]),
        l.toDataURL &&
          (void 0 === p && (p = 1), (v = l.toDataURL("image/" + g, p))));
      return v;
    };
    g.fn.detectPixelRatio = function (A) {
      ...
      for (l = 0; l < this.length; l += 1)
        (p = this[l]),
          ...
          (F = H(this[l])),
          F.scaled ||
            ((D = U.devicePixelRatio || 1),
            (r =
              v.webkitBackingStorePixelRatio ||
              v.mozBackingStorePixelRatio ||
              v.msBackingStorePixelRatio ||
              v.oBackingStorePixelRatio ||
              v.backingStorePixelRatio ||
              1),
            (D /= r),
            1 !== D &&
              ((r = p.width),
